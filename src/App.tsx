          ...
          <div className="p-6 max-w-2xl mx-auto w-full">
            ...
            <section className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-white">QR Codes untuk Scan</h3>
              </div>
              <p className="text-zinc-500 text-sm mb-8">
                Jika perangkat Anda tidak mendukung AR penuh, gunakan fitur QR Scan dan arahkan kamera ke kode di bawah ini untuk memunculkan objek.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {arData.map(model => (
                  <div key={model.id} className="bg-zinc-800/50 border border-white/10 p-4 rounded-2xl flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-zinc-500 text-xs">{model.category}</p>
                    </div>
                  </div>
                ))}
              </div>
